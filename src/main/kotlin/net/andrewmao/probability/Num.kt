...
object Num {
     ...
     *
     */
    const val RAC2 = 1.41421356237309504880
     ...
     * <I>y</I> = <IMG ALIGN="MIDDLE" BORDER="0" SRC="Numimg4.png" ALT="$\displaystyle {\frac{{a_0}}{2}}$"></IMG> + <SUB>j=1</SUB><SUP>n</SUP><I>a</I><SUB>j</SUB><I>T</I><SUB>j</SUB>(<I>x</I>).
    </DIV> * <P></P>
     ...
     */
    fun evalCheby(a: DoubleArray, n: Int, x: Double): Double {
        if (Math.abs(x) > 1.0) System.err.println(
